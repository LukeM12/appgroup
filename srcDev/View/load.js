...
function layPolygons(map)
{
	for(var i=0;i<ALLPOINTS.length;i++){
		...
		for(var q=0;q<ALLPOINTS[i].surr.length;q++){
				var surrPath = [new google.maps.LatLng(ALLPOINTS[i].lat,ALLPOINTS[i].lng),
				new google.maps.LatLng(ALLPOINTS[i].surr[q].lat,ALLPOINTS[i].surr[q].lng)];
